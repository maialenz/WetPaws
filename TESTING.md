...
Apart from that, I used an online app by [Media Genesis](https://responsivedesignchecker.com/) to check responsiveness on those screens I did not have access to. The results of these testings are on this [here](docs/deployment/device+browser-tests/device-responsiveness-1.png, docs/deployment/device+browser-tests/device-responsiveness-2.png, docs/deployment/device+browser-tests/device-responsiveness-3.png, docs/deployment/device+browser-tests/device-responsiveness-4.png)
## BUGS
